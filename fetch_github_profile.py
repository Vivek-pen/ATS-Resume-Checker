...
def fetch_github_profile(username):
    ...
    try:
        ...
        if profile_response.status_code != 200:
            error_msg = f"Profile not found. Status code: {profile_response.status_code}"
            if profile_response.status_code == 403:
                error_msg += ". API rate limit likely exceeded. Try adding a GITHUB_TOKEN to your .env file."
