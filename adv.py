...
def resume_analyser():
    ...
    def get_ai_analysis(resume_text, job_description):
        ...
        try:
            # Use the shared OpenRouter/OpenAI function
            # Import placed here or at top-level. Top level is better but I will add it to the import block in next step.
            # Here just the call.
            # Wait, I need to import it first. 
            from get_llm_output import get_llm_output
            
            response = get_llm_output(prompt, resume_text)
            return response
